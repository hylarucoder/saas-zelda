...
import xyz.zelda.gateway.exceptions.ForbiddenException
import java.net.URI
import java.net.URISyntaxException
import java.util.*
import javax.servlet.http.HttpServletRequest

class AuthRequestInterceptor(private val signingSecret: String, private val envConfig: EnvConfig) :
    PreForwardRequestInterceptor {
